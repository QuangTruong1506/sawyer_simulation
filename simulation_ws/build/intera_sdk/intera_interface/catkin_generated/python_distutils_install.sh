...
echo_and_run cd "/home/user/simulation_ws/src/intera_sdk/intera_interface"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/user/simulation_ws/src/intera_sdk/intera_interface/setup.py" \
    build --build-base "/home/user/simulation_ws/build/intera_sdk/intera_interface" \
    install \
    $DESTDIR_ARG \
